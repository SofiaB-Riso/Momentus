...
<aside class="sidebar">
    ...
    <?php if(session('notificacao')): ?>
        <div class="sidebar__aviso">
            <strong>Notificação:</strong> <?php echo e(session('notificacao')); ?>

        </div>
    <?php endif; ?>

    <nav class="sidebar__nav">
        <a href="<?php echo e(route('eventos.index')); ?>" class="sidebar__link <?php echo e(($ativo ?? '') === 'inicio' ? 'is-active' : ''); ?>">
        ...
        <a href="<?php echo e(route('eventos.create')); ?>" class="sidebar__link <?php echo e(($ativo ?? '') === 'planejar' ? 'is-active' : ''); ?>">
...
<?php /**PATH C:\Users\Cicero\Downloads\Momentus1\resources\views/layouts/partials/sidebar-dashboard.blade.php ENDPATH**/ ?>